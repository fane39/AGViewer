...
AGViewer is a lightweight AmigaGuide (`.guide`) file viewer implemented in Python using Tkinter. It aims to provide an authentic Amiga-like reading experience on modern operating systems, supporting complex node navigation, text formatting, and interactive commands. Made with the help of AI.
